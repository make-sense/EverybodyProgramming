...
//			ActionTable actions = (Instantiate(actor.action) as GameObject).GetComponentInChildren<ActionTable> () as ActionTable;
			ActionTable actions = GameObject.Find(actor.action.name.ToString ()).GetComponentInChildren<ActionTable> () as ActionTable;
